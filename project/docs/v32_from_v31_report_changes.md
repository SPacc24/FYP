...
- Version-range-only, package-provenance, module-dependent, configuration-dependent, authenticated-user, TLS/certificate, SQL-backend, SSH/SFTP, and role-specific CVEs move to **Conditional Candidate (High chance of matching)**. OS-context mismatches are excluded.
