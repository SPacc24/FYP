...
class OperationManager:
    ...
    def start_operation(self, adversary_id, selected_techniques=None, group='red', planner_id=None):
        ...
        if not readiness['ok']:
            return {'ok': False, 'stage': 'connectivity', 'message': readiness['message']}
        if not readiness['agent_ready']:
            return {'ok': False, 'stage': 'agent_check', 'message': 'No trusted Sandcat agent is currently online.'}
        ...
        try:
            ...
            return {'ok': False, 'stage': 'operation_create', 'message': str(e)}
    ...
    def poll_operation(self, operation_id):
        try:
            ...
            return {'ok': False, 'stage': 'operation_poll', 'message': str(e)}
